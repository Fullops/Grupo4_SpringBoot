package com.agutierrezt.academic.exceptions.advice;

import com.agutierrezt.academic.dtos.response.ErrorDto;
...
@ControllerAdvice
public class EleccionesExceptionHandler {

    @ExceptionHandler(value = EleccionesException.class)
    protected ResponseEntity<Object> handleException(EleccionesException ex, WebRequest request) {
